...
3. The vite-plus skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
...
_Generated from [AbsolutelySkilled](https://www.absolutelyskilled.pro/skill/vite-plus)_
